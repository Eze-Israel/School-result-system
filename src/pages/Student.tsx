...
const Student = () => {
  ...
  return (
    ...
    <div
      className="md:min-h-screen md:bg-cover bg-center md:bg-[url('/images/design.jpg')] bg-no-repeat md:flex md:items-center justify-center relative "
    >
          ...
          <form onSubmit={handleSubmit} className="space-y-4 form">
             <div className='md:pl-26 username'>
              ...
              <input
                id="username"
                type="text"
                className="w-full border-b-2 border-gray-400 focus:outline-none focus:border-purple-600 "
                value={username}
