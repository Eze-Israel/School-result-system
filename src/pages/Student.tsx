...
const Student = () => {
  ...
  return (
   <>
    <div
      className="min-h-screen bg-cover bg-center md:bg-[url('/images/design.jpg')] bg-no-repeat flex md:items-center md:justify-center relative mobile"
    >
        <div className="md:w-1/2">
                  <div className="ellipse-2"><img  alt="Ellipse" src="/images/student.png" /></div>
       </div>
        ...
        <Link href="/">
            ...
            />
            <h2 className="text-xl md:text-3xl font-bold block text-center md:mb-9 welcome">Next Result System </h2>
            </div>

            <h1 className="text-xl md:text-4xl font-bold block text-center md:mb-9 welcome">Welcome</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 form">
             <div className='md:pl-26 username'>
              ...
              <input
                id="username"
                type="text"
                className="w-full border-b-2 border-gray-400 focus:outline-none focus:border-purple-600 px-7 "
                value={username}
