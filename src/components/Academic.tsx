  ...
  return (
    <div className='my-12'>
        ...
        <h2 className='text-blue-500'>News on the GO!</h2>
            <p className='text-black'>Stay updated! never lose a hint as we tend to drive you 
        ...
        <p className='text-black'>Comprehensive curriculum with emphasis on critical thinking.</p>
        </div>
